...
- **Code Red** / **Code Blue:** tap starts a **10s phone alarm** (campus silent). Arming takes over the screen — **Send now** / **Cancel** stay in view (no scroll). Auto-send at 0. Then loop until All clear. Only one code at a time; All clear grayed until a code is active.
